(module
 ...
 (data (i32.const 208) "eosio.token\00")
 (data (i32.const 224) "only true EOS token is allowed\00")
 (data (i32.const 256) "you need at least 0.1 EOS to create an new signature\00")
 ...
 (data (i32.const 1056) "don\'t have enough CMU for unstake\00")
 (data (i32.const 1104) "active\00")
 (data (i32.const 1120) "dacincubator\00")
 (data (i32.const 1136) "transfer token by unstake\00")
 (data (i32.const 1168) "buy some new token\00")
 (data (i32.const 1200) "only true EOS token is allowed.\00")
 (data (i32.const 1232) "only true CMU token is allowed\00")
 (data (i32.const 1264) "sell some new token\00")
