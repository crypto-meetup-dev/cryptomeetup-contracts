(module
 ...
 (data (i32.const 1184) "dacincubator\00")
 (data (i32.const 1200) "buy some new token\00")
 (data (i32.const 1232) "no land exist\00")
 (data (i32.const 1248) "no enough eos\00")
 (data (i32.const 1264) "cannot buy with yourself\00")
 (data (i32.const 1296) "transfer ownership\00")
 (data (i32.const 1328) "mining token by reference\00")
 (data (i32.const 1360) "mining token by play game\00")
